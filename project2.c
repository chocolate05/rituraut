...
/*		werase(help);
	...
	//	box(botwin, 0, 0);
		...
		mvwprintw(botwin, 4, 0, "  ^G Get Help     ^W Search Word     ^K Cut Text      ^C Cur Pos      ^Y Prev Page    M-1 First Line  M-W WhereIs Next^^ Mark Text  \n   ^X Exit         ^R Read File       ^U Uncut Text    ^_ Go To Line   ^V Next Page    M-/ Last Line");
		wmove(textwin, 0, 0);
